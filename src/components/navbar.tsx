...
const NavBar: React.FC = () => {
    ...
    return (
        ...
        <div className="  text-white py-6 md:max-w-full w-[200px]fixed w-full md:mx20  bg-gray-900/80 backdrop-blur-xl z-50 ">
            <div className=" md:mx-10 mx-2 flex justify-between text-sm max-w-full">
